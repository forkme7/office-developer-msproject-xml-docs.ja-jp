---
title: Project 要素の XML スキーマ
TOCTitle: Project 要素の XML スキーマ
ms:assetid: d25633d3-3350-40d6-801d-fbb3809b52b8
ms:mtpsurl: https://msdn.microsoft.com/ja-jp/library/Bb968695(v=office.12)
ms:contentKeyID: 16747843
ms.date: 06/30/2008
...
次に示すのは、Microsoft Office Project 2007 XML データ交換スキーマ (mspdi\_pj12.xsd) の **Project** 要素を定義しているセクションです。

**OutlineCodes**、**WBSMasks**、**ExtendedAttributes**、**Calendars**、**Tasks**、**Resources**、および **Assignments** 要素はすべて、**Project** 要素内で定義されています。ただし、これらの要素のそれぞれの詳細なスキーマ情報は、このスキーマ リファレンス内の各トピックで示されています。
