---
title: Calendars 要素の XML スキーマ
TOCTitle: Calendars 要素の XML スキーマ
ms:assetid: 7afbe811-c94e-4ff6-8968-5b9aede4393a
ms:mtpsurl: https://msdn.microsoft.com/ja-jp/library/Bb968557(v=office.12)
ms:contentKeyID: 16740359
ms.date: 06/30/2008
...
次に示すのは、Microsoft Office Project 2007 XML データ交換スキーマ (mspdi\_pj12.xsd) の **Calendars** 要素を定義しているセクションです。

完全な Project 2007 XML データ交換スキーマは、Project 2007 SDK ダウンロードに収められています。Project 2007 SDK ダウンロードへのリンクについては、「[Microsoft Office Project 2007 SDK へようこそ](https://msdn.microsoft.com/ja-jp/library/ms512767\(v=office.12\))」を参照してください。
