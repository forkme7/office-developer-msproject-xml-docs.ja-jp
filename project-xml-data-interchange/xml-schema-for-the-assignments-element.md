---
title: Assignments 要素の XML スキーマ
TOCTitle: Assignments 要素の XML スキーマ
ms:assetid: 0f1de37d-fa67-4120-9d24-c98d7067f842
ms:mtpsurl: https://msdn.microsoft.com/ja-jp/library/Bb968414(v=office.12)
ms:contentKeyID: 16731774
ms.date: 06/30/2008
...
次に示すのは、Microsoft Office Project 2007 XML データ交換スキーマ (mspdi\_pj12.xsd) で **Assignments** 要素を定義しているセクションです。
