---
title: Resources 要素の XML スキーマ
TOCTitle: Resources 要素の XML スキーマ
ms:assetid: 56a91683-2a3e-4879-a0ef-dcb7918c4965
ms:mtpsurl: https://msdn.microsoft.com/ja-jp/library/Bb968511(v=office.12)
ms:contentKeyID: 16737465
ms.date: 06/30/2008
...
次に示すのは、Microsoft Office Project 2007 XML データ交換スキーマ (mspdi\_pj12.xsd) で **Resources** 要素を定義しているセクションです。
