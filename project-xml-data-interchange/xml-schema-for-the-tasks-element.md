---
title: Tasks 要素の XML スキーマ
TOCTitle: Tasks 要素の XML スキーマ
ms:assetid: 0ff12ab6-ac7f-4d45-aadc-7f6fce6c082c
ms:mtpsurl: https://msdn.microsoft.com/ja-jp/library/Bb968415(v=office.12)
ms:contentKeyID: 16731844
ms.date: 06/30/2008
...
次に示すのは、Microsoft Office Project 2007 XML データ交換スキーマ (mspdi\_pj12.xsd) で **Tasks** 要素を定義しているセクションです。
